...
Route::post('/castVotePost/{id}', [\App\Http\Controllers\api\VoteCastAPIController::class, 'castVotePost']);
Route::post('/uploadImage', [VoterRegisterationController::class, 'imageUpload']);
