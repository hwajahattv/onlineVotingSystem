            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card overflow-hidden">
                        <div class="card-body">
                            <h3 class="text-center display-3">Update school details</h3>
                            <form method="POST" action="{{ route('school.update',['school'=>$school[0]->id]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="education_level"
                                                    ...
                                                    <option selected value="{{$school[0]->LevelID}}">{{$school[0]->Level}}</option>
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <select class="form-control" name="province"
                                                    ...
                                                    <option selected value="{{$school[0]->ProvinceID}}">{{$school[0]->Province}}</option>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control addInput" name="name"
                                                           id="" aria-describedby="" placeholder="" value="{{$school[0]->schoolName}}">
                                                </div>
                                            </div>
