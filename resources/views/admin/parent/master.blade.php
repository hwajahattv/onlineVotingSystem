    ...
    ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                <a class="add-project-sidebar btn btn-primary" href="" data-bs-toggle="modal" data-bs-target="#addProjectSidebar">+ New Election</a>
                ...
                <ul class="metismenu" id="menu">
                    <li>
                        ...
                        <span id="nameError" style="color: red" class="nav-text"> {{ Session::get('dltMessage') }}
                        </span>
                        @endif
                        <span id="dateError" style="color: red;" class="nav-text"></span>
                    </li>
                    <li><a href="{{ route('public.home') }}">
                            <img src="{{ asset('icons/home.ico') }}" class="flaticon-web" style="margin: 0 0.7rem 0 0;" width="28px" height="28px" alt="no-image">
                    ...
                    <li><a href="{{ route('home') }}">
                            <svg class="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M30 1.5H24C21.5147 1.5 19.5 3.51472 19.5 6V12C19.5 14.4853 21.5147 16.5 24 16.5H30C32.4853 16.5 34.5 14.4853 34.5 12V6C34.5 3.51472 32.4853 1.5 30 1.5Z" fill="#3ECDFF" />
                                <path d="M30 19.5H24C21.5147 19.5 19.5 21.5147 19.5 24V30C19.5 32.4853 21.5147 34.5 24 34.5H30C32.4853 34.5 34.5 32.4853 34.5 30V24C34.5 21.5147 32.4853 19.5 30 19.5Z" fill="#969BA0" />
                            </svg>
                    ...
                    <li><a href="{{ route('politicalPartySection') }}">
                            <img src="{{ asset('icons/party.png') }}" class="flaticon-web" style="margin: 0 0.7rem 0 0;" width="28px" height="28px" alt="no-image">
                    ...
                    <li><a href="{{ route('adminUsers') }}">
                            {{-- <i class="flaticon-web"></i> --}}
                            <img src="{{ asset('icons/admin.png') }}" class="flaticon-web" style="margin: 0 0.7rem 0 0;" width="28px" height="28px" alt="no-image">
                    ...
                    <div class="modal-body">
                        <form id="formoid" action="{{ route('addNewElection') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <div class="cal-icon"><input type="date" id="date" name="date" class="form-control"><i class="far fa-calendar-alt"></i></div>
                            </div>
                            <div class="form-group">
                                <button type="submit" id="btn-submit" class="btn btn-primary updateBtnTarget">CREATE
                                </button>
                            </div>
                        </form>
                    </div>
