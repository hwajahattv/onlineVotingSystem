                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control addInput" name="name" id=""
                                    aria-describedby="" value="{{ $voter->name }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control addInput" name="CNIC" id=""
                                    aria-describedby="" value="{{ $voter->CNIC }}" maxlength="13">
                                <small id="emailHelp" class="form-text text-muted">Enter the voter CNIC # without
                                    dashes
                                    (-).</small>
                            </div>
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control addInput" name="phone_no" id=""
                                    aria-describedby="" value="{{ $voter->phone_no }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control addInput" name="address" id=""
                                    aria-describedby="" value="{{ $voter->address }}">
                            </div>
                        </div>
                        <div class="col-md-6">
