                ...
                <div class="card">
                    <div class="card-header d-block border-0 pb-0">
                        <div class="pb-3">
                            ...
                            @if(!$majority)
                            <a href="{{route('fetchResults3',['district'=>$district,'election'=>$election->id])}}" class="btn btn-outline-primary">Count 3rd Preference Votes</a>
                        ...
                        <div class="d-flex align-items-center">
                            <span class="fs-36 text-black font-w600 me-4">2nd preference Results</span>
