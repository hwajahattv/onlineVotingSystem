                                    ...
                                    <div class="form-group wrapper">
                                        <div>
                                            ...
                                            <div class="wrapper">
                                                ...
                                                <div id="openBrowserButton"
                                                    class=" card cardUpload card-block d-inline-flex">
                                                    <input type="file" name="profile_pic" id="files" hidden
                                                        onchange="PreviewImage();">
                                                    <img class="imgCard mt-4 mb-2" id="uploadPreview"
                                                        src="{{ asset('login_page_assets/img/uploadIcon.png') }}"
                                                        class="mt-3" />
                                                    <h4 class="fw-bold display-7 text-center" id="uploadText">Upload
                                                        picture</h4>
                                                </div>
                                            </div> --}}
