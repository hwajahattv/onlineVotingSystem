                            ...
                            <div class="card-body box-style">
                                <div class="media align-items-center">
                                    <div class="media-body me-3">
                                        ...
                                        @if(array_key_exists($candidate->id, $voteCount))
                                            <span class="count num-text text-black font-w700">{{$voteCount[$candidate->id]->c}}</span>
                                            <input type="hidden" class="countData" value="{{$voteCount[$candidate->id]->c}}">

                                        @else
                                            <span class="count num-text text-black font-w700">0</span>
                                            <input type="hidden" class="countData" value="0">
